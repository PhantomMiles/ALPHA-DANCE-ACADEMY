        ...
        cartItems.forEach((item, index) => {
            ...
            itemElement.innerHTML = `
                ...
                <div class="flex items-center justify-center w-full mx-auto">
                    ...
                    <input type="text" class="border-y border-gray-200 outline-none text-gray-900 font-semibold text-lg w-full  placeholder:text-gray-900 py-[15px] text-center bg-transparent" value="${item.quantity}" onchange="updateQuantity(${index})">
